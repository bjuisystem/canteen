...
public class CommonController {
    ...
    public R<String> upload(MultipartFile file){
        ...
        // 转储文件 D:\IDEA workspace\task\canteen-master\picture
        try {
            // basePath使用绝对路径指定存储位置
            String basePath = "D:\\workspace\\canteen-master\\picture\\";
            //String basePath = "D:/IDEA workspace/task/canteen-master/picture/";
